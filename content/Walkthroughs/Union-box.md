...
draft = false
tags = ["Linux", "HTB", "Hack The Box", "medium", "MySQL", "SQL Injection", "UNION", "GroupConcat", "Header Injection", "Privilege Escalation", "Command Injection", "PHP", "Web Security", "Fuzzing", "Nginx"]
