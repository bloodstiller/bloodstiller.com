+++
title = "SQLi Vulnerabilities: Lab 5: SQL injection UNION attack, retrieving data from other tables"
date = 2025-11-13
lastmod = 2025-11-13
draft = false
author = "bloodstiller"
...
## Lab 5: SQL injection UNION attack, retrieving data from other tables: {#lab-5-sql-injection-union-attack-retrieving-data-from-other-tables}
...
{{< figure src="/ox-hugo/2025-11-13_06-47.png" >}}
...
{{< figure src="/ox-hugo/2025-11-13_07-05.png" >}}
...
**Additional Import**:
For us to parse and extract the administrators password we need the BeautifulSoup library.
